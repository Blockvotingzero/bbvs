...
import NigeriaStatesMap from "@/components/NigeriaStatesMap"; // Added import
...
export default function Home() {
  ...
  return (
    <div className="container py-6 space-y-6"> {/* Added container class */}
      <NigeriaStatesMap /> {/* Added NigeriaStatesMap component */}
